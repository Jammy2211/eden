...
sed -i 's/from test_autoconf.mock/from mock/g' $PYEUCLID_CTI_PATH/*/*/*/*.py
sed -i 's/from VIS_CTI_AutoConf_Conf.autoconf import exc/from VIS_CTI_AutoConf_Conf import exc/g' $PYEUCLID_CTI_PATH/*/*/*/*.py
sed -i 's/from VIS_CTI_AutoConf_Conf.tests.mock_real/from VIS_CTI_AutoConf_Conf.mock_real/g' $PYEUCLID_CTI_PATH/*/*/*/*.py
