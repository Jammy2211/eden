echo "Copying autofit/tools/ -> VIS_AutoFit_Tools"

AUTO_SRC_PATH_TOOLS=$AUTOFIT_EDEN_PATH"/autofit/tools"
VIS_SRC_PATH_TOOLS=$VIS_AUTOFIT_PATH"/VIS_AutoFit_Tools/python/VIS_AutoFit_Tools"
...
VIS_TEST_PATH_TOOLS=$VIS_AUTOFIT_PATH"/VIS_AutoFit_Tools/tests/python"
