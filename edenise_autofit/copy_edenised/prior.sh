echo "Copying autofit/mapper/prior -> VIS_CTI_AutoFit_Prior"

AUTO_SRC_PATH_PRIOR=$AUTOFIT_EDEN_PATH"/autofit/mapper/prior"
VIS_SRC_PATH_PRIOR=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoFit_Prior/python/VIS_CTI_AutoFit_Prior"

cp -r $AUTO_SRC_PATH_PRIOR/* $VIS_SRC_PATH_PRIOR/

AUTO_TEST_PATH_MAPPER=$AUTOFIT_EDEN_PATH"/test_autofit/unit/mapper"
VIS_TEST_PATH_PRIOR=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoFit_Prior/tests/python"
