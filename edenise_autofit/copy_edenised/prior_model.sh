echo "Copying autofit/mapper/prior_model -> VIS_AutoFit_PriorModel"

AUTO_SRC_PATH_PRIORMODEL=$AUTOFIT_EDEN_PATH"/autofit/mapper/prior_model"
VIS_SRC_PATH_PRIORMODEL=$VIS_AUTOFIT_PATH"/VIS_AutoFit_PriorModel/python/VIS_AutoFit_PriorModel"

cp -r $AUTO_SRC_PATH_PRIORMODEL/* $VIS_SRC_PATH_PRIORMODEL/

AUTO_TEST_PATH_MAPPER=$AUTOFIT_EDEN_PATH"/test_autofit/unit/mapper"
VIS_TEST_PATH_PRIORMODEL=$VIS_AUTOFIT_PATH"/VIS_AutoFit_PriorModel/tests/python"

cp -r $AUTOFIT_EDEN_PATH/test_autofit/unit/mapper/model/test_prior_model.py $VIS_TEST_PATH_PRIORMODEL/
rm $VIS_AUTOFIT_PATH/VIS_AutoFit_Mapper/tests/python/test_prior_model.py
