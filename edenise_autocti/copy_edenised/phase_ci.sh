echo "Copying autocti/pipeline/phase/ci_imaging -> VIS_CTI_Phase_CI"

AUTO_SRC_PATH_PHASE=$AUTOCTI_EDEN_PATH"/autocti/pipeline/phase/ci_imaging"
VIS_SRC_PATH_PHASE=$VIS_AUTOCTI_PATH"/VIS_CTI_Phase_CI/python/VIS_CTI_Phase_CI"
...
VIS_TEST_PATH_PHASE=$VIS_AUTOCTI_PATH"/VIS_CTI_Phase_CI/tests/python"
