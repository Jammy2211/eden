echo "Copying autocti/fit -> VIS_CTI_AutoCTI_Phase_Extensions"

AUTO_SRC_PATH_PHASE=$AUTOCTI_EDEN_PATH"/autocti/pipeline/phase/extensions"
VIS_SRC_PATH_PHASE=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoCTI_Phase_Extensions/python/VIS_CTI_AutoCTI_Phase_Extensions"
...
VIS_TEST_PATH_PHASE=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoCTI_Phase_Extensions/tests/python"
