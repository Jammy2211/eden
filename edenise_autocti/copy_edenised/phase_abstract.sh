echo "Copying autocti/pipeline/phase/abstract -> VIS_CTI_Phase_Abstract"

AUTO_SRC_PATH_PHASE=$AUTOCTI_EDEN_PATH"/autocti/pipeline/phase/abstract"
VIS_SRC_PATH_PHASE=$VIS_AUTOCTI_PATH"/VIS_CTI_Phase_Abstract/python/VIS_CTI_Phase_Abstract"
...
VIS_TEST_PATH_PHASE=$VIS_AUTOCTI_PATH"/VIS_CTI_Phase_Abstract/tests/python"
