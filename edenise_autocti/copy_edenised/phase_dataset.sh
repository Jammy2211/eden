echo "Copying autocti/pipeline/phase/dataset -> VIS_CTI_AutoCTI_Phase_Dataset"

AUTO_SRC_PATH_PHASE=$AUTOCTI_EDEN_PATH"/autocti/pipeline/phase/dataset"
VIS_SRC_PATH_PHASE=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoCTI_Phase_Dataset/python/VIS_CTI_AutoCTI_Phase_Dataset"
...
VIS_TEST_PATH_PHASE=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoCTI_Phase_Dataset/tests/python"
