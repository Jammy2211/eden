echo "Copying autoarray/structures -> VIS_CTI_AutoArray_Frame"

AUTO_SRC_PATH_FRAME=$AUTOARRAY_EDEN_PATH"/autoarray/structures"
VIS_SRC_PATH_FRAME=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Frame/python/VIS_CTI_AutoArray_Frame"
...
VIS_TEST_PATH_FRAME=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Frame/tests/python"
