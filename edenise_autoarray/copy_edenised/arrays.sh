echo "Copying autoarray/structures -> VIS_CTI_AutoArray_Array"

AUTO_SRC_PATH_ARRAY=$AUTOARRAY_EDEN_PATH"/autoarray/structures"
VIS_SRC_PATH_ARRAY=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Array/python/VIS_CTI_AutoArray_Array"
...
VIS_TEST_PATH_ARRAY=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Array/tests/python"
