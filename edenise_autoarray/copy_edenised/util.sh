echo "Copying autoarray/util -> VIS_CTI_AutoArray_Util"

AUTO_SRC_PATH_UTIL=$AUTOARRAY_EDEN_PATH"/autoarray/util"
VIS_SRC_PATH_UTIL=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Util/python/VIS_CTI_AutoArray_Util"
...
VIS_TEST_PATH_UTIL=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Util/tests/python"
