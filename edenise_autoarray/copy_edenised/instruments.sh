echo "Copying autoarray/instruments -> VIS_CTI_AutoArray_Instruments"

AUTO_SRC_PATH_INSTRUMENTS=$AUTOARRAY_EDEN_PATH"/autoarray/instruments"
VIS_SRC_PATH_INSTRUMENTS=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Instruments/python/VIS_CTI_AutoArray_Instruments"
...
VIS_TEST_PATH_INSTRUMENTS=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Instruments/tests/python"
