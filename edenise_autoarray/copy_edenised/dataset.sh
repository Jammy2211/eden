echo "Copying autoarray/dataset -> VIS_AutoArray_Dataset"

AUTO_SRC_PATH_DATASET=$AUTOARRAY_EDEN_PATH"/autoarray/dataset"
VIS_SRC_PATH_DATASET=$VIS_AUTOARRAY_PATH"/VIS_AutoArray_Dataset/python/VIS_AutoArray_Dataset"
...
VIS_TEST_PATH_DATASET=$VIS_AUTOARRAY_PATH"/VIS_AutoArray_Dataset/tests/python"
