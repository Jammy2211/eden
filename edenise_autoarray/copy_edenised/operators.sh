echo "Copying autoarray/operators -> VIS_CTI_AutoArray_Operators"

AUTO_SRC_PATH_OPERATORS=$AUTOARRAY_EDEN_PATH"/autoarray/operators"
VIS_SRC_PATH_OPERATORS=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Operators/python/VIS_CTI_AutoArray_Operators"
...
VIS_TEST_PATH_OPERATORS=$PYEUCLID_CTI_PATH"/VIS_CTI_AutoArray_Operators/tests/python"
